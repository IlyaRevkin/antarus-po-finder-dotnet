...
///
/// Просьба была такая: «важно, чтобы при печати настройки не сбивались: печатать с двух сторон,
...
public class PassportPrintTicketTests
{
    ...
    /// <summary>ПАСПОРТ — буклет: две страницы на лист И переворот по короткому краю. Просьба:
    ...
    /// <summary>Двусторонняя печать паспорта включена по умолчанию — так и задумано — и едет ко
