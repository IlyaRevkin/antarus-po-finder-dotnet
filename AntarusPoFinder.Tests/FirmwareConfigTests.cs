...
/// FirmwareConfigService). Слова владельца: «одна прошивка с разными настройками может быть: типа 1
...
public class FirmwareConfigTests : IDisposable
{
    ...
    /// <summary>Ровно то, чего просил владелец: наладчик вводит название своего шкафа и получает ОДНУ
