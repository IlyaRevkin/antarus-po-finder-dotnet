...
/// принтер и своя строка под названием. Просьба Ильи была общей — «в целом добавь больше
...
public class LabelVariabilityTests
{
    ...
    {
        // Поправка Ильи: «кст текст не инструкция, а руководство по эксплуатации» — это читает заказчик.
