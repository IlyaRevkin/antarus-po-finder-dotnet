...
/// <summary>Поиск мусора и неправильно лежащих файлов на диске прошивок. Просьба была такая:
...
///
/// <b>Главное свойство — не съесть нужное.</b> отдельно оговаривалось продумать, «чтобы svg или какие-то
