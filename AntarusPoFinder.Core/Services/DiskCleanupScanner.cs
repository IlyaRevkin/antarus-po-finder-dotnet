...
/// <see cref="Apply"/> идемпотентен и продолжаем) и переименование прошивки: его целиком делает
/// мигратор, здесь его результат только заворачивается в находку (см. <see cref="PlanRenames"/>) —
/// второй реализации канонического имени в проекте быть не должно.
///
