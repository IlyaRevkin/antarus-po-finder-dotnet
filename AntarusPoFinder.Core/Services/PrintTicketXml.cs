...
///
/// Зачем вообще: по паспорту требование было дословно такое — «важно, чтобы при печати настройки не сбивались:
...
///
/// ДВА РАЗНЫХ РЕЖИМА (просьба): «для паспорта мне нужно как буклет печатать, разворачивая
...
///     честно как «2-up + короткий край», и это разрешено на случай, когда драйвер
