...
///   • <see cref="AccessKey"/>/<see cref="SecretKey"/> — ЧЕМ подписывать. Это доступ на запись во
///     весь бакет, поэтому они держатся как пароли: не уезжают в общий конфиг и хранятся
///     зашифрованными (см. ConfigService.S3SecretKey);
