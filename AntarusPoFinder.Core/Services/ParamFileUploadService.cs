...
/// и описание.
///
/// Как стало (полная история версий, как у прошивок, здесь сознательно НЕ заводится — нужно было
...
public static class ParamFileUploadService
{
    ...
    /// при перезаливке». Требование («без истории как у прошивок; кому нужна старая — пусть
