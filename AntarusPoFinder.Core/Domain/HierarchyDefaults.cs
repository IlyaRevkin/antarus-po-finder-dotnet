...
public static class HierarchyDefaultsData
{
    ...
    [
        ...
        // Pixel/Pixel2 нумеруются собственной 4-значной ревизией платы (1020, 1321, 3422…), и именно
        // она и есть hw_version — версия прошивки под конкретную ревизию должна совпадать по hw с
        // ревизией шкафа (hw_version в имени файла дополняется до 4 знаков, см. FwVersionNumber).
        // Раньше в сиде тут стояли выдуманные 40-51 — их выправили на реальные ревизии.
        new("PIXEL2", "PIXEL2", 1000, 1, "универсальный"),
        new("PIXEL2", "PIXEL2-1020", 1020, 2, "8DI / 6DO / 8AI / 2AO"),
        new("PIXEL2", "PIXEL2-1021", 1021, 3, "8DI / 5DO / 8AI / 4AO"),
        new("PIXEL2", "PIXEL2-1320", 1320, 4, "8DI / 6DO / 6AI / 2AO"),
        new("PIXEL2", "PIXEL2-1321", 1321, 5, "8DI / 5DO / 6AI / 4AO"),
        new("PIXEL2", "PIXEL2-3022", 3022, 6, "16DI / 12DO"),
        new("PIXEL2", "PIXEL2-3322", 3322, 7, "16DI / 8DO / 4AI"),
        new("PIXEL2", "PIXEL2-3422", 3422, 8, "16DI / 8DO / 4AO"),
        ...
        new("PIXEL", "PIXEL-2511", 2511, 1, "первое поколение Pixel, требует уточнения характеристик"),
        new("PIXEL", "PIXEL-2512", 2512, 2, "первое поколение Pixel, требует уточнения характеристик"),
        new("PIXEL", "PIXEL-2514", 2514, 3, "первое поколение Pixel, требует уточнения характеристик"),
        new("PIXEL", "PIXEL-2515", 2515, 4, "первое поколение Pixel, требует уточнения характеристик"),
    ];
}
