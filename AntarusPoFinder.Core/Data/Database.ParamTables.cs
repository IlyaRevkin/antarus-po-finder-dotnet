...
public partial class Database
{
    ...
    /// <summary>Ревизии документа, САМАЯ СВЕЖАЯ ПЕРВОЙ — в том же порядке, в каком их показывает
    /// список слева (и в каком показывает версии программы «История изменений»).
    /// Строки не тянутся: список ревизий их не показывает, а строк в каждой сотни.</summary>
    ...
    /// <summary>Следующий свободный номер ревизии документа. От МАКСИМАЛЬНОГО, включая снятые: номер
    /// — то, чем ревизию называют вслух («вернулись к третьей»), и переиспользовать номер удалённой
    /// значит завести в разговоре двух разных «третьих».</summary>
