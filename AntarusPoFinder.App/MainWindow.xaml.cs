...
public partial class MainWindow : Window
{
    ...
    private static readonly Dictionary<string, (string Title, string Body)> NavStepText = new()
    {
        ...
        ["passports"] = ("Паспорта шкафов", "Шаблоны паспортов, которые печатают и вкладывают в шкаф. Привязаны к типу шкафа, а не к версии прошивки, поэтому находятся и у шкафов, для которых прошивки нет вовсе."),
