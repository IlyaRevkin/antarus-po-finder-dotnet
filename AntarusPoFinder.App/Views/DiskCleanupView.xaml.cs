...
/// <summary>Страница «Чистка диска» — просьба Ильи: «надо сделать чистильщика который будет искать
/// мусорные файлы не подходящие под структуру и предлагать переименовать как они должны быть или
/// удалить». Вся логика — в <see cref="DiskCleanupScanner"/>; здесь только предпросмотр и
/// подтверждение.
///
