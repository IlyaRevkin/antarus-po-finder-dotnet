...
/// прочитать их можно было только растянув столбец или скопировав строку. Просьба Ильи от 13.08.2026:
/// «при наведении на ячейку была подсказка полностью текста, если он не влез в ячейку».
///
