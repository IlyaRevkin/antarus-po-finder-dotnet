...
///
/// <b>Тикетов у очереди ТРИ, и они разные — на этом кнопка и обожглась.</b> Симптом был такой:
/// считывалось не текущее состояние драйвера, а умолчание, которое стоит у него при первом
/// подключении.
/// <list type="bullet">
