...
public static class ConfigSyncService
{
    ...
    private static readonly HashSet<string> SkipSettingsKeys = new()
    {
        ...
        // Бланк паспорта, выбранный в окне печати в прошлый раз — привычка конкретного наладчика, а
        // не политика. Сама папка бланков и метка подстановки, наоборот, синхронизируются: бланки
